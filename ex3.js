...
let getFilteredTotalGoals = (minGoals, teamPlayers) => {
    ...
    let sum = listPlayerFilter.reduce((total, player) => total + player.goals,0);
    return sum;
};



console.log(`Tổng các bàn thắng của cầu thủ đạt chỉ tiêu là: ${getFilteredTotalGoals(10,players)}`);